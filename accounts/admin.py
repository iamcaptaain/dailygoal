...
#     # Here we create new user with all the required parameters.
...
class AdminUser_profile(admin.ModelAdmin):

    list_display = ['user','first_name', 'last_name', 'sex', 'mobile',]
...
admin.site.register(User_Profiles,AdminUser_profile)
